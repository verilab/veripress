...
[![Docker Repository](https://img.shields.io/badge/docker-veripress/veripress-blue.svg)](https://hub.docker.com/r/veripress/veripresst/)
...
$ cd ~/my-veripress
$ veripress init  # Initialize a VeriPress instance
$ veripress theme install default  # Install the "default" theme
$ veripress preview  # Preview the instance
```

Run the above commands and you can visit the very initial VeriPress instance at `http://127.0.0.1:8080/`.
...
If you want to help to develop VeriPress, fork this repo and send me a pull request. Source codes of docs and demo are also available in this repo, so if you have find some mistakes, feel free to send me a pull request too.
